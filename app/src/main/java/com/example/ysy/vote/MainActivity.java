...
public class MainActivity extends AppCompatActivity {
    ...
    private String doVote(String  voteStr){
        ...
        try {
            ...
            String urlPath= "http://10.240.13.35:8080/vote/GetVote";
            ...
            //设置请求体的长度
            httpURLConnection.setRequestProperty("Content-Langth", String . valueOf(data.length));
            //获得输出流,向服务器写入数据
